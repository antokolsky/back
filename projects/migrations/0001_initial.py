    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photos', imagekit.models.fields.ProcessedImageField(upload_to='project_photos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='interested_users', to='projects.project')),
